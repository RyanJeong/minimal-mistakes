...
* 즉, **<i>S, T, 0, ..., 9, <, >, ||, X</i>**로 표현한 16진수
    * marker 더하면 17진수
        * 하나의 테잎이 두 개의 저장 공간을 갖고 있다고 생각해 보라
        * 테잎 한 쪽엔 위치 정보를 기록하는 marker(*)를 기록하고, 다른 한 쪽엔 정보를 저장
...
* References: 
    ...
    * 이광근. (2016). *SNU 046.016 컴퓨터과학이 여는 세계(Computational Civilization) Part I* [PowerPoint slides]. Retrieved from [http://ropas.snu.ac.kr/~kwang/046.016/15/1h4in1.pdf](http://ropas.snu.ac.kr/~kwang/046.016/15/1h4in1.pdf).
